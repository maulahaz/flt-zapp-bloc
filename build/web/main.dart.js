...
define('zapp_user_main', ['dart_sdk', 'flutter_sdk'], (function load__zapp_user_main(dart_sdk, flutter_sdk) {
  ...
  var x_groceries = Object.create(dart.library);
  ...
  var grocery_pg = Object.create(dart.library);
  var grocery_tile = Object.create(dart.library);
  ...
  var T$ = {
    ...
    BuildContextAndintToGroceryTile: () => (T$.BuildContextAndintToGroceryTile = dart.constFn(dart.fnType(grocery_tile.GroceryTile, [framework.BuildContext, core.int])))(),
    ...
    BuildContextAndintToGroceryTile$1: () => (T$.BuildContextAndintToGroceryTile$1 = dart.constFn(dart.fnType(grocery_tile$.GroceryTile, [framework.BuildContext, core.int])))(),
  ...
  dart.defineLazy(CT, {
    ...
    get C115() {
      return C[115] = dart.fn(bloc_provider.BlocProvider._startListening, T$.InheritedContextOfStateStreamableNAndStateStreamableToFn());
    },
    get C116() {
  ...
  var I = [
    ...
    "file:///zapp/project/lib/modules/grocery/controllers/grocery_bloc.dart",
    "file:///zapp/project/lib/modules/grocery/models/grocery_mdl.dart",
    "file:///zapp/project/lib/modules/grocery/pages/grocery_pg.dart",
    "file:///zapp/project/lib/modules/grocery/pages/parts/grocery_tile.dart",
    "package:flutter_app/modules/grocery/controllers/grocery_bloc.dart",
    ...
    "package:flutter_app/modules/grocery/models/grocery_mdl.dart",
    "package:flutter_app/modules/grocery/pages/grocery_pg.dart",
    "package:flutter_app/modules/grocery/pages/parts/grocery_tile.dart",
  ...
  main.MyApp = class MyApp extends framework.StatelessWidget {
    ...
    build(context) {
      return new app.MaterialApp.new({debugShowCheckedModeBanner: false, title: "Flutter App!!", theme: themes.MyThemes.lightMode, darkTheme: themes.MyThemes.darkMode, home: new grocery_pg.GroceryPage.new()});
    }
  };
  ...
  dart.defineLazy(grocery_mdl.GroceryData, {
    /*grocery_mdl.GroceryData.groceryItems*/get groceryItems() {
      return T$.JSArrayOfMapOfString$dynamic().of([new (T$.IdentityMapOfString$dynamic()).from(["id", "1", "name", "Bananas", "description", "Fresh bananas from Ecuador", "price", 0.49, "imageUrl", "https://source.unsplash.com/6uAssP0vuPs"]), new (T$.IdentityMapOfString$dynamic()).from(["id", "2", "name", "Grapes", "description", "Organic, locally grown apples", "price", 1.99, "imageUrl", "https://source.unsplash.com/2pPw5Glro5I"]), new (T$.IdentityMapOfString$dynamic()).from(["id", "3", "name", "Bread", "description", "Brown Bread, Tasty", "price", 2.49, "imageUrl", "https://source.unsplash.com/gouGFACv-sk"]), new (T$.IdentityMapOfString$dynamic()).from(["id", "4", "name", "Brown Eggs", "description", "Farm-fresh brown eggs", "price", 3.99, "imageUrl", "https://source.unsplash.com/byl3G0-ZwZ0"])]);
    },
    set groceryItems(value) {}
  }, false);
  grocery_pg.GroceryPage = class GroceryPage extends framework.StatefulWidget {
    static ['_#new#tearOff'](opts) {
      let key = opts && 'key' in opts ? opts.key : null;
      return new grocery_pg.GroceryPage.new({key: key});
    }
    createState() {
      return new grocery_pg._GroceryPageState.new();
    }
  };
  (grocery_pg.GroceryPage.new = function(opts) {
    let key = opts && 'key' in opts ? opts.key : null;
    grocery_pg.GroceryPage.__proto__.new.call(this, {key: key});
    ;
  }).prototype = grocery_pg.GroceryPage.prototype;
  dart.addTypeTests(grocery_pg.GroceryPage);
  dart.addTypeCaches(grocery_pg.GroceryPage);
  dart.setMethodSignature(grocery_pg.GroceryPage, () => ({
    __proto__: dart.getMethods(grocery_pg.GroceryPage.__proto__),
    createState: dart.fnType(framework.State$(grocery_pg.GroceryPage), [])
  }));
  dart.setLibraryUri(grocery_pg.GroceryPage, I[6]);
  grocery_pg._GroceryPageState = class _GroceryPageState extends framework.State$(grocery_pg.GroceryPage) {
    initState() {
      this.groceryBloc.add(new grocery_bloc$.GroceryInitialEvent.new());
      super.initState();
    }
    build(context) {
      return new scaffold.Scaffold.new({appBar: new app_bar.AppBar.new({title: new text.Text.new("Zapp with BLoC"), centerTitle: true}), body: new (T$.BlocConsumerOfGroceryBloc$GroceryState()).new({bloc: this.groceryBloc, listener: dart.fn((context, state) => {
            ...
            if (grocery_bloc$.GroceryFetchSuccessState.is(state)) {
              return new scroll_view.ListView.builder({itemCount: state.data[$length], itemBuilder: dart.fn((context, index) => new grocery_tile.GroceryTile.new({bloc: this.groceryBloc, dtModel: state.data[$_get](index)}), T$.BuildContextAndintToGroceryTile())});
            }
            if (grocery_bloc$.GroceryFetchErrorState.is(state)) {
              return new basic.Center.new({child: new text.Text.new("Error")});
            } else {
  ...
  (grocery_pg._GroceryPageState.new = function() {
    this.groceryBloc = new grocery_bloc$.GroceryBloc.new();
    grocery_pg._GroceryPageState.__proto__.new.call(this);
    ;
  }).prototype = grocery_pg._GroceryPageState.prototype;
  dart.addTypeTests(grocery_pg._GroceryPageState);
  dart.addTypeCaches(grocery_pg._GroceryPageState);
  dart.setMethodSignature(grocery_pg._GroceryPageState, () => ({
    __proto__: dart.getMethods(grocery_pg._GroceryPageState.__proto__),
    build: dart.fnType(framework.Widget, [framework.BuildContext])
  }));
  dart.setLibraryUri(grocery_pg._GroceryPageState, I[6]);
  dart.setFieldSignature(grocery_pg._GroceryPageState, () => ({
    __proto__: dart.getFields(grocery_pg._GroceryPageState.__proto__),
    groceryBloc: dart.finalFieldType(grocery_bloc$.GroceryBloc)
  }));
  var dtModel$ = dart.privateName(grocery_tile, "GroceryTile.dtModel");
  var bloc$0 = dart.privateName(grocery_tile, "GroceryTile.bloc");
  grocery_tile.GroceryTile = class GroceryTile extends framework.StatelessWidget {
    get dtModel() {
      return this[dtModel$];
    }
    set dtModel(value) {
    ...
    static ['_#new#tearOff'](opts) {
      let key = opts && 'key' in opts ? opts.key : null;
      let dtModel = opts && 'dtModel' in opts ? opts.dtModel : null;
      let bloc = opts && 'bloc' in opts ? opts.bloc : null;
      return new grocery_tile.GroceryTile.new({key: key, dtModel: dtModel, bloc: bloc});
    }
    build(context) {
      return new container.Container.new({margin: new edge_insets.EdgeInsets.all(10), padding: new edge_insets.EdgeInsets.all(10), decoration: new box_decoration.BoxDecoration.new({color: colors$1.kAppPrimary._get(200), borderRadius: new border_radius.BorderRadius.circular(16)}), child: new basic.Column.new({crossAxisAlignment: flex.CrossAxisAlignment.start, children: T$.JSArrayOfWidget().of([new container.Container.new({height: 200, width: 1.7976931348623157e+308, decoration: new box_decoration.BoxDecoration.new({image: new decoration_image.DecorationImage.new({fit: box_fit.BoxFit.cover, image: new _network_image_web.NetworkImage.new(this.dtModel.imageUrl)})})}), new basic.SizedBox.new({height: 5}), new text.Text.new(this.dtModel.name, {style: widgets_hlp.getFont(18, {isBold: true})}), new text.Text.new(this.dtModel.description), new basic.SizedBox.new({height: 5}), new basic.Row.new({mainAxisAlignment: flex.MainAxisAlignment.spaceBetween, children: T$.JSArrayOfWidget().of([new text.Text.new("$" + this.dtModel.price[$toString](), {style: widgets_hlp.getFont(18, {isBold: true})}), new basic.Row.new({children: T$.JSArrayOfWidget().of([new icon_button.IconButton.new({onPressed: dart.fn(() => {
                        core.print("Clicked");
                      }, T$.VoidTovoid()), icon: new icon.Icon.new(icons.Icons.favorite_border)}), new icon_button.IconButton.new({onPressed: dart.fn(() => {
                        core.print("Clicked");
                      }, T$.VoidTovoid()), icon: new icon.Icon.new(icons.Icons.shopping_bag_outlined)})])})])})])})});
    }
  };
  (grocery_tile.GroceryTile.new = function(opts) {
    let key = opts && 'key' in opts ? opts.key : null;
    let dtModel = opts && 'dtModel' in opts ? opts.dtModel : null;
    let bloc = opts && 'bloc' in opts ? opts.bloc : null;
    this[dtModel$] = dtModel;
    this[bloc$0] = bloc;
    grocery_tile.GroceryTile.__proto__.new.call(this, {key: key});
    ;
  }).prototype = grocery_tile.GroceryTile.prototype;
  dart.addTypeTests(grocery_tile.GroceryTile);
  dart.addTypeCaches(grocery_tile.GroceryTile);
  dart.setMethodSignature(grocery_tile.GroceryTile, () => ({
    __proto__: dart.getMethods(grocery_tile.GroceryTile.__proto__),
    build: dart.fnType(framework.Widget, [framework.BuildContext])
  }));
  dart.setLibraryUri(grocery_tile.GroceryTile, I[7]);
  dart.setFieldSignature(grocery_tile.GroceryTile, () => ({
    __proto__: dart.getFields(grocery_tile.GroceryTile.__proto__),
    dtModel: dart.finalFieldType(grocery_mdl$.GroceryModel),
    bloc: dart.finalFieldType(grocery_bloc$.GroceryBloc)
  }));
  grocery_bloc$.GroceryEvent = class GroceryEvent extends core.Object {};
  (grocery_bloc$.GroceryEvent.new = function() {
    ;
  ...
  dart.addTypeTests(grocery_bloc$.GroceryEvent);
  dart.addTypeCaches(grocery_bloc$.GroceryEvent);
  dart.setLibraryUri(grocery_bloc$.GroceryEvent, I[8]);
  grocery_bloc$.GroceryState = class GroceryState extends core.Object {};
  (grocery_bloc$.GroceryState.new = function() {
    ;
  }).prototype = grocery_bloc$.GroceryState.prototype;
  dart.addTypeTests(grocery_bloc$.GroceryState);
  dart.addTypeCaches(grocery_bloc$.GroceryState);
  dart.setLibraryUri(grocery_bloc$.GroceryState, I[8]);
  grocery_bloc$.GroceryBloc = class GroceryBloc extends bloc$.Bloc$(grocery_bloc$.GroceryEvent, grocery_bloc$.GroceryState) {
    static ['_#new#tearOff']() {
      return new grocery_bloc$.GroceryBloc.new();
    }
  ...
  dart.setLibraryUri(grocery_bloc$.GroceryBloc, I[8]);
  grocery_bloc$.GroceryInitialEvent = class GroceryInitialEvent extends grocery_bloc$.GroceryEvent {
    static ['_#new#tearOff']() {
      return new grocery_bloc$.GroceryInitialEvent.new();
    }
  ...
  dart.addTypeTests(grocery_bloc$.GroceryInitialEvent);
  dart.addTypeCaches(grocery_bloc$.GroceryInitialEvent);
  dart.setLibraryUri(grocery_bloc$.GroceryInitialEvent, I[8]);
  grocery_bloc$.GroceryInitialFetchEvent = class GroceryInitialFetchEvent extends grocery_bloc$.GroceryEvent {
    static ['_#new#tearOff']() {
      return new grocery_bloc$.GroceryInitialFetchEvent.new();
    }
  ...
  dart.addTypeTests(grocery_bloc$.GroceryInitialFetchEvent);
  dart.addTypeCaches(grocery_bloc$.GroceryInitialFetchEvent);
  dart.setLibraryUri(grocery_bloc$.GroceryInitialFetchEvent, I[8]);
  grocery_bloc$.GroceryAddEvent = class GroceryAddEvent extends grocery_bloc$.GroceryEvent {
    static ['_#new#tearOff']() {
      return new grocery_bloc$.GroceryAddEvent.new();
    }
  ...
  dart.addTypeTests(grocery_bloc$.GroceryAddEvent);
  dart.addTypeCaches(grocery_bloc$.GroceryAddEvent);
  dart.setLibraryUri(grocery_bloc$.GroceryAddEvent, I[8]);
  grocery_bloc$.GroceryActionState = class GroceryActionState extends grocery_bloc$.GroceryState {};
  (grocery_bloc$.GroceryActionState.new = function() {
    ;
  }).prototype = grocery_bloc$.GroceryActionState.prototype;
  dart.addTypeTests(grocery_bloc$.GroceryActionState);
  dart.addTypeCaches(grocery_bloc$.GroceryActionState);
  dart.setLibraryUri(grocery_bloc$.GroceryActionState, I[8]);
  grocery_bloc$.GroceryInitialState = class GroceryInitialState extends grocery_bloc$.GroceryState {
    static ['_#new#tearOff']() {
      return new grocery_bloc$.GroceryInitialState.new();
    }
  ...
  dart.addTypeTests(grocery_bloc$.GroceryInitialState);
  dart.addTypeCaches(grocery_bloc$.GroceryInitialState);
  dart.setLibraryUri(grocery_bloc$.GroceryInitialState, I[8]);
  grocery_bloc$.GroceryFetchLoadingState = class GroceryFetchLoadingState extends grocery_bloc$.GroceryState {
    static ['_#new#tearOff']() {
      return new grocery_bloc$.GroceryFetchLoadingState.new();
    }
  ...
  dart.addTypeTests(grocery_bloc$.GroceryFetchLoadingState);
  dart.addTypeCaches(grocery_bloc$.GroceryFetchLoadingState);
  dart.setLibraryUri(grocery_bloc$.GroceryFetchLoadingState, I[8]);
  ...
  dart.addTypeTests(grocery_bloc$.GroceryFetchSuccessState);
  dart.addTypeCaches(grocery_bloc$.GroceryFetchSuccessState);
  dart.setLibraryUri(grocery_bloc$.GroceryFetchSuccessState, I[8]);
  dart.setFieldSignature(grocery_bloc$.GroceryFetchSuccessState, () => ({
    __proto__: dart.getFields(grocery_bloc$.GroceryFetchSuccessState.__proto__),
    data: dart.finalFieldType(core.List$(grocery_mdl$.GroceryModel))
  }));
  ...
  dart.addTypeTests(grocery_bloc$.GroceryFetchErrorState);
  dart.addTypeCaches(grocery_bloc$.GroceryFetchErrorState);
  dart.setLibraryUri(grocery_bloc$.GroceryFetchErrorState, I[8]);
  grocery_bloc$.GroceryAdditionSuccessState = class GroceryAdditionSuccessState extends grocery_bloc$.GroceryActionState {
    static ['_#new#tearOff']() {
      return new grocery_bloc$.GroceryAdditionSuccessState.new();
    }
  ...
  dart.addTypeTests(grocery_bloc$.GroceryAdditionSuccessState);
  dart.addTypeCaches(grocery_bloc$.GroceryAdditionSuccessState);
  dart.setLibraryUri(grocery_bloc$.GroceryAdditionSuccessState, I[8]);
  grocery_bloc$.GroceryAdditionErrorState = class GroceryAdditionErrorState extends grocery_bloc$.GroceryActionState {
    static ['_#new#tearOff']() {
      return new grocery_bloc$.GroceryAdditionErrorState.new();
    }
  ...
  dart.addTypeTests(grocery_bloc$.GroceryAdditionErrorState);
  dart.addTypeCaches(grocery_bloc$.GroceryAdditionErrorState);
  dart.setLibraryUri(grocery_bloc$.GroceryAdditionErrorState, I[8]);
  ...
  bloc_builder.BlocBuilderBase$ = dart.generic((B, S) => {
    ...
    dart.setLibraryUri(BlocBuilderBase, I[9]);
  ...
  bloc_builder.BlocBuilder$ = dart.generic((B, S) => {
    ...
    dart.setLibraryUri(BlocBuilder, I[9]);
  ...
  bloc_builder._BlocBuilderBaseState$ = dart.generic((B, S) => {
    ...
    dart.setLibraryUri(_BlocBuilderBaseState, I[9]);
  ...
  var bloc$2 = dart.privateName(bloc_consumer, "BlocConsumer.bloc");
  ...
  bloc_consumer.BlocConsumer$ = dart.generic((B, S) => {
    ...
    dart.setLibraryUri(BlocConsumer, I[10]);
  ...
  bloc_consumer._BlocConsumerState$ = dart.generic((B, S) => {
    ...
    dart.setLibraryUri(_BlocConsumerState, I[10]);
  ...
  var bloc$3 = dart.privateName(bloc_listener, "BlocListenerBase.bloc");
  ...
  dart.setLibraryUri(nested.SingleChildStatefulWidget, I[11]);
  ...
  bloc_listener.BlocListenerBase$ = dart.generic((B, S) => {
    ...
    dart.setLibraryUri(BlocListenerBase, I[12]);
  ...
  bloc_listener.BlocListener$ = dart.generic((B, S) => {
    ...
    dart.setLibraryUri(BlocListener, I[12]);
    return BlocListener;
  });
  ...
  nested.SingleChildState$ = dart.generic(T => {
    ...
    dart.setLibraryUri(SingleChildState, I[11]);
  ...
  bloc_listener._BlocListenerBaseState$ = dart.generic((B, S) => {
    ...
    class _BlocListenerBaseState extends nested.SingleChildState$(bloc_listener.BlocListenerBase$(B, S)) {
      ...
      buildWithChild(context, child) {
        if (!(child != null)) dart.assertFailed(dart.str(this.widget[$runtimeType]) + " used outside of MultiBlocListener must specify a child", I[13], 180, 7, "child != null");
        if (this.widget.bloc == null) {
    ...
    dart.setLibraryUri(_BlocListenerBaseState, I[12]);
  ...
  dart.setLibraryUri(nested.SingleChildStatelessWidget, I[11]);
  ...
  bloc_provider.BlocProvider$ = dart.generic(T => {
    ...
    class BlocProvider extends nested.SingleChildStatelessWidget {
      ...
      buildWithChild(context, child) {
        if (!(child != null)) dart.assertFailed(dart.str(this[$runtimeType]) + " used outside of MultiBlocProvider must specify a child", I[14], 115, 7, "child != null");
        let value = this[_value$];
        return value != null ? new (__t$InheritedProviderOfT()).value({value: value, startListening: C[115] || CT.C115, lazy: this.lazy, child: child}) : new (__t$InheritedProviderOfT()).new({create: this[_create$], dispose: dart.fn((_, bloc) => bloc.close(), __t$BuildContextAndTTovoid()), startListening: C[115] || CT.C115, lazy: this.lazy, child: child});
      }
  ...
  var bloc$4 = dart.privateName(bloc_selector, "BlocSelector.bloc");
  ...
  bloc_selector.BlocSelector$ = dart.generic((B, S, T) => {
    ...
    dart.setLibraryUri(BlocSelector, I[16]);
  ...
  bloc_selector._BlocSelectorState$ = dart.generic((B, S, T) => {
    ...
    dart.setLibraryUri(_BlocSelectorState, I[16]);
  ...
  (nested.Nested.new = function(opts) {
    ...
    let children = opts && 'children' in opts ? opts.children : null;
    let child = opts && 'child' in opts ? opts.child : null;
    if (!children[$isNotEmpty]) dart.assertFailed(null, I[17], 71, 16, "children.isNotEmpty");
  ...
  dart.setLibraryUri(nested.Nested, I[11]);
  ...
  dart.setLibraryUri(multi_bloc_listener.MultiBlocListener, I[19]);
  ...
  dart.setLibraryUri(multi_bloc_provider.MultiBlocProvider, I[20]);
  ...
  dart.setLibraryUri(multi_repository_provider.MultiRepositoryProvider, I[21]);
  ...
  provider$.InheritedProvider$ = dart.generic(T => {
    ...
    class InheritedProvider extends nested.SingleChildStatelessWidget {
      ...
      buildWithChild(context, child) {
        if (!(this.builder != null || child != null)) dart.assertFailed(dart.str(this[$runtimeType]) + " used outside of MultiProvider must specify a child", I[23], 158, 7, "builder != null || child != null");
  ...
  provider$.Provider$ = dart.generic(T => {
    ...
    (Provider.value = function(opts) {
      ...
      if (!dart.fn(() => {
        ...
        return true;
      }, T$.VoidTobool())()) dart.assertFailed(null, I[22], 243, 16, "() {\n          Provider.debugCheckInvalidValueType?.call<T>(value);\n          return true;\n        }()");
  ...
  repository_provider.RepositoryProvider$ = dart.generic(T => {
    ...
    dart.setLibraryUri(RepositoryProvider, I[24]);
  ...
  dart.addTypeTests(themes$.MyThemes);
  dart.addTypeCaches(themes$.MyThemes);
  dart.setLibraryUri(themes$.MyThemes, I[25]);
  dart.setStaticFieldSignature(themes$.MyThemes, () => ['lightMode', 'darkMode']);
  dart.defineLazy(themes$.MyThemes, {
    /*themes$.MyThemes.lightMode*/get lightMode() {
  ...
  utils_hlp.MyUtils = class MyUtils extends core.Object {
    ...
    getCurrentDateTime(opts) {
      ...
      let now = new core.DateTime.now();
      let fmt = (t5 = format, t5 == null ? "dd MMM yyyy HH:mm" : t5);
  ...
  dart.setLibraryUri(utils_hlp.MyUtils, I[26]);
  ...
  widgets_hlp.getFont = function getFont(fontSize, opts) {
    ...
    return new text_style.TextStyle.new({fontSize: fontSize, color: (t5 = color, t5 == null ? colors$1.kBlack : t5), fontWeight: isBold ? ui.FontWeight.bold : ui.FontWeight.normal, fontFamily: fontName});
  };
  ...
  dart.addTypeTests(grocery_mdl$.GroceryModel);
  dart.addTypeCaches(grocery_mdl$.GroceryModel);
  dart.setLibraryUri(grocery_mdl$.GroceryModel, I[27]);
  dart.setFieldSignature(grocery_mdl$.GroceryModel, () => ({
    __proto__: dart.getFields(grocery_mdl$.GroceryModel.__proto__),
    id: dart.finalFieldType(core.String),
    name: dart.finalFieldType(core.String),
  ...
  dart.addTypeTests(grocery_mdl$.GroceryData);
  dart.addTypeCaches(grocery_mdl$.GroceryData);
  dart.setLibraryUri(grocery_mdl$.GroceryData, I[27]);
  dart.setStaticFieldSignature(grocery_mdl$.GroceryData, () => ['groceryItems']);
  dart.defineLazy(grocery_mdl$.GroceryData, {
    /*grocery_mdl$.GroceryData.groceryItems*/get groceryItems() {
      return T$.JSArrayOfMapOfString$dynamic().of([new (T$.IdentityMapOfString$dynamic()).from(["id", "1", "name", "Bananas", "description", "Fresh bananas from Ecuador", "price", 0.49, "imageUrl", "https://source.unsplash.com/6uAssP0vuPs"]), new (T$.IdentityMapOfString$dynamic()).from(["id", "2", "name", "Grapes", "description", "Organic, locally grown apples", "price", 1.99, "imageUrl", "https://source.unsplash.com/2pPw5Glro5I"]), new (T$.IdentityMapOfString$dynamic()).from(["id", "3", "name", "Bread", "description", "Brown Bread, Tasty", "price", 2.49, "imageUrl", "https://source.unsplash.com/gouGFACv-sk"]), new (T$.IdentityMapOfString$dynamic()).from(["id", "4", "name", "Brown Eggs", "description", "Farm-fresh brown eggs", "price", 3.99, "imageUrl", "https://source.unsplash.com/byl3G0-ZwZ0"])]);
  ...
  dart.setLibraryUri(grocery_pg$.GroceryPage, I[28]);
  grocery_pg$._GroceryPageState = class _GroceryPageState extends framework.State$(grocery_pg$.GroceryPage) {
    initState() {
      this.groceryBloc.add(new grocery_bloc$.GroceryInitialEvent.new());
      super.initState();
    ...
    build(context) {
      return new scaffold.Scaffold.new({appBar: new app_bar.AppBar.new({title: new text.Text.new("Zapp with BLoC"), centerTitle: true}), body: new (T$.BlocConsumerOfGroceryBloc$GroceryState()).new({bloc: this.groceryBloc, listener: dart.fn((context, state) => {
            ...
            if (grocery_bloc$.GroceryFetchSuccessState.is(state)) {
              return new scroll_view.ListView.builder({itemCount: state.data[$length], itemBuilder: dart.fn((context, index) => new grocery_tile$.GroceryTile.new({bloc: this.groceryBloc, dtModel: state.data[$_get](index)}), T$.BuildContextAndintToGroceryTile$1())});
            }
            if (grocery_bloc$.GroceryFetchErrorState.is(state)) {
              return new basic.Center.new({child: new text.Text.new("Error")});
            } else {
  ...
  dart.setLibraryUri(grocery_pg$._GroceryPageState, I[28]);
  dart.setFieldSignature(grocery_pg$._GroceryPageState, () => ({
    __proto__: dart.getFields(grocery_pg$._GroceryPageState.__proto__),
    groceryBloc: dart.finalFieldType(grocery_bloc$.GroceryBloc)
  }));
  var dtModel$0 = dart.privateName(grocery_tile$, "GroceryTile.dtModel");
  var bloc$5 = dart.privateName(grocery_tile$, "GroceryTile.bloc");
  grocery_tile$.GroceryTile = class GroceryTile extends framework.StatelessWidget {
    get dtModel() {
      return this[dtModel$0];
    }
    set dtModel(value) {
      super.dtModel = value;
    }
  ...
  dart.setLibraryUri(grocery_tile$.GroceryTile, I[29]);
  dart.setFieldSignature(grocery_tile$.GroceryTile, () => ({
    __proto__: dart.getFields(grocery_tile$.GroceryTile.__proto__),
    dtModel: dart.finalFieldType(grocery_mdl$.GroceryModel),
    bloc: dart.finalFieldType(grocery_bloc$.GroceryBloc)
  ...
  dart.setLibraryUri(bloc_observer.BlocObserver, I[30]);
  ...
  change.Change$ = dart.generic(State => {
    ...
    dart.setLibraryUri(Change, I[32]);
  ...
  transition.Transition$ = dart.generic((Event, State) => {
    ...
    dart.setLibraryUri(Transition, I[34]);
  ...
  async_provider.StreamProvider$ = dart.generic(T => {
    ...
    dart.setLibraryUri(StreamProvider, I[35]);
  ...
  async_provider.FutureProvider$ = dart.generic(T => {
    ...
    dart.setLibraryUri(FutureProvider, I[35]);
  ...
  listenable_provider.ListenableProvider$ = dart.generic(T => {
    ...
    dart.setLibraryUri(ListenableProvider, I[36]);
  ...
  change_notifier_provider.ChangeNotifierProvider$ = dart.generic(T => {
    ...
    dart.setLibraryUri(ChangeNotifierProvider, I[37]);
  ...
  listenable_provider.ListenableProxyProvider0$ = dart.generic(R => {
    ...
    dart.setLibraryUri(ListenableProxyProvider0, I[36]);
  ...
  listenable_provider.ListenableProxyProvider$ = dart.generic((T, R) => {
    ...
    dart.setLibraryUri(ListenableProxyProvider, I[36]);
  ...
  change_notifier_provider.ChangeNotifierProxyProvider$ = dart.generic((T, R) => {
    ...
    dart.setLibraryUri(ChangeNotifierProxyProvider, I[37]);
  ...
  change_notifier_provider.ChangeNotifierProxyProvider0$ = dart.generic(R => {
    ...
    dart.setLibraryUri(ChangeNotifierProxyProvider0, I[37]);
  ...
  listenable_provider.ListenableProxyProvider2$ = dart.generic((T, T2, R) => {
    ...
    dart.setLibraryUri(ListenableProxyProvider2, I[36]);
  ...
  change_notifier_provider.ChangeNotifierProxyProvider2$ = dart.generic((T, T2, R) => {
    ...
    dart.setLibraryUri(ChangeNotifierProxyProvider2, I[37]);
  ...
  listenable_provider.ListenableProxyProvider3$ = dart.generic((T, T2, T3, R) => {
    ...
    dart.setLibraryUri(ListenableProxyProvider3, I[36]);
  ...
  change_notifier_provider.ChangeNotifierProxyProvider3$ = dart.generic((T, T2, T3, R) => {
    ...
    dart.setLibraryUri(ChangeNotifierProxyProvider3, I[37]);
  ...
  listenable_provider.ListenableProxyProvider4$ = dart.generic((T, T2, T3, T4, R) => {
    ...
    dart.setLibraryUri(ListenableProxyProvider4, I[36]);
  ...
  change_notifier_provider.ChangeNotifierProxyProvider4$ = dart.generic((T, T2, T3, T4, R) => {
    ...
    dart.setLibraryUri(ChangeNotifierProxyProvider4, I[37]);
  ...
  listenable_provider.ListenableProxyProvider5$ = dart.generic((T, T2, T3, T4, T5, R) => {
    ...
    dart.setLibraryUri(ListenableProxyProvider5, I[36]);
  ...
  change_notifier_provider.ChangeNotifierProxyProvider5$ = dart.generic((T, T2, T3, T4, T5, R) => {
    ...
    dart.setLibraryUri(ChangeNotifierProxyProvider5, I[37]);
  ...
  listenable_provider.ListenableProxyProvider6$ = dart.generic((T, T2, T3, T4, T5, T6, R) => {
    ...
    dart.setLibraryUri(ListenableProxyProvider6, I[36]);
  ...
  change_notifier_provider.ChangeNotifierProxyProvider6$ = dart.generic((T, T2, T3, T4, T5, T6, R) => {
    ...
    dart.setLibraryUri(ChangeNotifierProxyProvider6, I[37]);
  ...
  consumer.Consumer$ = dart.generic(T => {
    ...
    dart.setLibraryUri(Consumer, I[38]);
  ...
  consumer.Consumer2$ = dart.generic((A, B) => {
    ...
    dart.setLibraryUri(Consumer2, I[38]);
  ...
  consumer.Consumer3$ = dart.generic((A, B, C) => {
    ...
    dart.setLibraryUri(Consumer3, I[38]);
  ...
  consumer.Consumer4$ = dart.generic((A, B, C, D) => {
    ...
    dart.setLibraryUri(Consumer4, I[38]);
  ...
  consumer.Consumer5$ = dart.generic((A, B, C, D, E) => {
    ...
    dart.setLibraryUri(Consumer5, I[38]);
  ...
  consumer.Consumer6$ = dart.generic((A, B, C, D, E, F) => {
    ...
    dart.setLibraryUri(Consumer6, I[38]);
  ...
  dart.setLibraryUri(provider$.ProviderNullException, I[18]);
  ...
  provider$._CreateDeferredInheritedProviderElement$ = dart.generic((T, R) => {
    ...
    class _CreateDeferredInheritedProviderElement extends provider$._DeferredDelegateState$(T, R, provider$._CreateDeferredInheritedProvider$(T, R)) {
      get controller() {
        let t7, t6;
        if (!this[_didBuild]) {
          if (!this.debugSetInheritedLock(true)) dart.assertFailed(null, I[39], 186, 14, "debugSetInheritedLock(true)");
          ...
          try {
            ...
            if (!dart.fn(() => {
              ...
              return true;
            }, T$.VoidTobool())()) dart.assertFailed(null, I[39], 206, 16, "() {\n          debugIsInInheritedProviderCreate =\n              _debugPreviousIsInInheritedProviderCreate!;\n          debugIsInInheritedProviderUpdate =\n              _debugPreviousIsInInheritedProviderUpdate!;\n          return true;\n        }()");
          }
          this[_didBuild] = true;
        }
  ...
  provider$.PostEventSpy = class PostEventSpy extends core.Object {
    ...
    dispose() {
      if (!dart.equals(provider$._debugPostEventOverride, dart.bind(this, _postEvent))) dart.assertFailed("disposed a spy different from the current spy", I[40], 43, 7, "_debugPostEventOverride == _postEvent");
  ...
  dart.setLibraryUri(nested.SingleChildWidgetElementMixin, I[11]);
  ...
  dart.setLibraryUri(nested.SingleChildStatelessElement, I[11]);
  ...
  provider$._InheritedProviderScope$ = dart.generic(T => {
    ...
    (_InheritedProviderScope.new = function(opts) {
      ...
      if (!T.is(null)) dart.assertFailed(null, I[23], 341, 16, "null is T");
    ...
    class _InheritedProviderScopeElement extends framework.InheritedElement {
            ...
            for (let updateShouldNotify of __t$ListOfTTobool().as(dependencies.selectors)) {
              try {
                if (!dart.fn(() => {
                  ...
                  return true;
                }, T$.VoidTobool())()) dart.assertFailed(null, I[23], 480, 20, "() {\n              _debugIsSelecting = true;\n              return true;\n            }()");
                shouldNotify = updateShouldNotify(this.value);
              } finally {
                if (!dart.fn(() => {
                  provider$._debugIsSelecting = false;
                  return true;
                }, T$.VoidTobool())()) dart.assertFailed(null, I[23], 486, 20, "() {\n              _debugIsSelecting = false;\n              return true;\n            }()");
              }
              if (shouldNotify) {
                break;
              }
      ...
      [_debugSetInheritedLock](value) {
        if (!dart.fn(() => {
          ...
          return true;
        }, T$.VoidTobool())()) dart.assertFailed(null, I[23], 582, 12, "() {\n      _debugInheritLocked = value;\n      return true;\n    }()");
        return true;
      }
      get value() {
  ...
  provider$._CreateInheritedProvider$ = dart.generic(T => {
    ...
    (_CreateInheritedProvider.new = function(opts) {
      ...
      this.startListening = startListening;
      this.dispose = dispose;
      if (!(create != null || update != null)) dart.assertFailed(null, I[23], 674, 16, "create != null || update != null");
    ...
    class _CreateInheritedProviderState extends provider$._DelegateState$(T, provider$._CreateInheritedProvider$(T)) {
      get value() {
        ...
        if (!dart.fn(() => {
          ...
          _debugPreviousIsInInheritedProviderUpdate = provider$.debugIsInInheritedProviderUpdate;
          return true;
        }, T$.VoidTobool())()) dart.assertFailed(null, I[23], 718, 12, "() {\n      _debugPreviousIsInInheritedProviderCreate =\n          debugIsInInheritedProviderCreate;\n      _debugPreviousIsInInheritedProviderUpdate =\n          debugIsInInheritedProviderUpdate;\n      return true;\n    }()");
        if (!this[_didInitValue]) {
          this[_didInitValue] = true;
          if (this.delegate.create != null) {
            if (!this.debugSetInheritedLock(true)) dart.assertFailed(null, I[23], 729, 16, "debugSetInheritedLock(true)");
            try {
              if (!dart.fn(() => {
                provider$.debugIsInInheritedProviderCreate = true;
                provider$.debugIsInInheritedProviderUpdate = false;
                return true;
              }, T$.VoidTobool())()) dart.assertFailed(null, I[23], 731, 18, "() {\n            debugIsInInheritedProviderCreate = true;\n            debugIsInInheritedProviderUpdate = false;\n            return true;\n          }()");
              ...
              if (!dart.fn(() => {
                ...
                provider$.debugIsInInheritedProviderUpdate = dart.nullCheck(_debugPreviousIsInInheritedProviderUpdate);
                return true;
              }, T$.VoidTobool())()) dart.assertFailed(null, I[23], 745, 18, "() {\n            debugIsInInheritedProviderCreate =\n                _debugPreviousIsInInheritedProviderCreate!;\n            debugIsInInheritedProviderUpdate =\n                _debugPreviousIsInInheritedProviderUpdate!;\n            return true;\n          }()");
            }
            if (!this.debugSetInheritedLock(false)) dart.assertFailed(null, I[23], 753, 16, "debugSetInheritedLock(false)");
            if (!dart.fn(() => {
              let t9;
              t9 = __t$TToNvoid().as(this.delegate.debugCheckInvalidValueType);
              t9 == null ? null : t9(T.as(this[_value$0]));
              return true;
            }, T$.VoidTobool())()) dart.assertFailed(null, I[23], 755, 16, "() {\n          delegate.debugCheckInvalidValueType?.call(_value as T);\n          return true;\n        }()");
          }
          if (__t$BuildContextAndTNToNT().as(this.delegate.update) != null) {
            try {
              ...
              if (!dart.fn(() => {
                ...
                provider$.debugIsInInheritedProviderUpdate = dart.nullCheck(_debugPreviousIsInInheritedProviderUpdate);
                return true;
              }, T$.VoidTobool())()) dart.assertFailed(null, I[23], 769, 18, "() {\n            debugIsInInheritedProviderCreate =\n                _debugPreviousIsInInheritedProviderCreate!;\n            debugIsInInheritedProviderUpdate =\n                _debugPreviousIsInInheritedProviderUpdate!;\n            return true;\n          }()");
            }
            if (!dart.fn(() => {
              let t9;
              t9 = __t$TToNvoid().as(this.delegate.debugCheckInvalidValueType);
              t9 == null ? null : t9(T.as(this[_value$0]));
              return true;
            }, T$.VoidTobool())()) dart.assertFailed(null, I[23], 778, 16, "() {\n          delegate.debugCheckInvalidValueType?.call(_value as T);\n          return true;\n        }()");
          }
        }
        dart.nullCheck(this.element)[_isNotifyDependentsEnabled] = false;
        ...
        dart.nullCheck(this.element)[_isNotifyDependentsEnabled] = true;
        if (!(__t$InheritedContextOfTNAndTToNFn().as(this.delegate.startListening) == null || this[_removeListener] != null)) dart.assertFailed(null, I[23], 788, 12, "delegate.startListening == null || _removeListener != null");
      ...
      build(opts) {
        ...
        if (isBuildFromExternalSources && this[_didInitValue] && __t$BuildContextAndTNToNT().as(this.delegate.update) != null) {
          ...
          if (!dart.fn(() => {
            ...
            _debugPreviousIsInInheritedProviderUpdate = provider$.debugIsInInheritedProviderUpdate;
            return true;
          }, T$.VoidTobool())()) dart.assertFailed(null, I[23], 839, 14, "() {\n        _debugPreviousIsInInheritedProviderCreate =\n            debugIsInInheritedProviderCreate;\n        _debugPreviousIsInInheritedProviderUpdate =\n            debugIsInInheritedProviderUpdate;\n        return true;\n      }()");
          try {
            if (!dart.fn(() => {
              provider$.debugIsInInheritedProviderCreate = false;
              provider$.debugIsInInheritedProviderUpdate = true;
              return true;
            }, T$.VoidTobool())()) dart.assertFailed(null, I[23], 847, 16, "() {\n          debugIsInInheritedProviderCreate = false;\n          debugIsInInheritedProviderUpdate = true;\n          return true;\n        }()");
            ...
            if (!dart.fn(() => {
              ...
              provider$.debugIsInInheritedProviderUpdate = dart.nullCheck(_debugPreviousIsInInheritedProviderUpdate);
              return true;
            }, T$.VoidTobool())()) dart.assertFailed(null, I[23], 854, 16, "() {\n          debugIsInInheritedProviderCreate =\n              _debugPreviousIsInInheritedProviderCreate!;\n          debugIsInInheritedProviderUpdate =\n              _debugPreviousIsInInheritedProviderUpdate!;\n          return true;\n        }()");
          }
          ...
          if (shouldNotify) {
            if (!dart.fn(() => {
              ...
              t9 == null ? null : t9(T.as(this[_value$0]));
              return true;
            }, T$.VoidTobool())()) dart.assertFailed(null, I[23], 873, 16, "() {\n          delegate.debugCheckInvalidValueType?.call(_value as T);\n          return true;\n        }()");
            if (this[_removeListener] != null) {
              dart.nullCheck(this[_removeListener])();
              this[_removeListener] = null;
            }
  ...
  provider$._ValueInheritedProviderState$ = dart.generic(T => {
    ...
    class _ValueInheritedProviderState extends provider$._DelegateState$(T, provider$._ValueInheritedProvider$(T)) {
      get value() {
        ...
        dart.nullCheck(this.element)[_isNotifyDependentsEnabled] = true;
        if (!(__t$InheritedContextOfTNAndTToNFn().as(this.delegate.startListening) == null || this[_removeListener] != null)) dart.assertFailed(null, I[23], 928, 12, "delegate.startListening == null || _removeListener != null");
        return this.delegate.value;
      }
      willUpdateDelegate(newDelegate) {
  ...
  provider$.spyPostEvent = function spyPostEvent() {
    if (!(provider$._debugPostEventOverride == null)) dart.assertFailed("postEvent is already spied", I[40], 22, 10, "_debugPostEventOverride == null");
  ...
  provider$['SelectContext|select'] = function SelectContext$124select(T, R, $this, selector) {
    ...
    try {
      ...
      if (!dart.fn(() => {
        provider$._debugIsSelecting = true;
        return true;
      }, T$.VoidTobool())()) dart.assertFailed(null, I[23], 279, 14, "() {\n        _debugIsSelecting = true;\n        return true;\n      }()");
      ...
      if (!dart.fn(() => {
        provider$._debugIsSelecting = false;
        return true;
      }, T$.VoidTobool())()) dart.assertFailed(null, I[23], 304, 14, "() {\n        _debugIsSelecting = false;\n        return true;\n      }()");
    }
  };
  ...
  proxy_provider.ProxyProvider0$ = dart.generic(R => {
    ...
    dart.setLibraryUri(ProxyProvider0, I[41]);
  ...
  proxy_provider.ProxyProvider$ = dart.generic((T, R) => {
    ...
    dart.setLibraryUri(ProxyProvider, I[41]);
  ...
  proxy_provider.ProxyProvider2$ = dart.generic((T, T2, R) => {
    ...
    dart.setLibraryUri(ProxyProvider2, I[41]);
  ...
  proxy_provider.ProxyProvider3$ = dart.generic((T, T2, T3, R) => {
    ...
    dart.setLibraryUri(ProxyProvider3, I[41]);
  ...
  proxy_provider.ProxyProvider4$ = dart.generic((T, T2, T3, T4, R) => {
    ...
    dart.setLibraryUri(ProxyProvider4, I[41]);
  ...
  proxy_provider.ProxyProvider5$ = dart.generic((T, T2, T3, T4, T5, R) => {
    ...
    dart.setLibraryUri(ProxyProvider5, I[41]);
  ...
  proxy_provider.ProxyProvider6$ = dart.generic((T, T2, T3, T4, T5, T6, R) => {
    ...
    dart.setLibraryUri(ProxyProvider6, I[41]);
  ...
  dart.setLibraryUri(reassemble_handler.ReassembleHandler, I[42]);
  ...
  selector$.Selector0$ = dart.generic(T => {
    ...
    dart.setLibraryUri(Selector0, I[43]);
  ...
  selector$._Selector0State$ = dart.generic(T => {
    ...
    dart.setLibraryUri(_Selector0State, I[43]);
  ...
  selector$.Selector$ = dart.generic((A, S) => {
    ...
    dart.setLibraryUri(Selector, I[43]);
    return Selector;
  });
  ...
  selector$.Selector2$ = dart.generic((A, B, S) => {
    ...
    dart.setLibraryUri(Selector2, I[43]);
    return Selector2;
  });
  ...
  selector$.Selector3$ = dart.generic((A, B, C, S) => {
    ...
    dart.setLibraryUri(Selector3, I[43]);
    return Selector3;
  });
  ...
  selector$.Selector4$ = dart.generic((A, B, C, D, S) => {
    ...
    dart.setLibraryUri(Selector4, I[43]);
    return Selector4;
  });
  ...
  selector$.Selector5$ = dart.generic((A, B, C, D, E, S) => {
    ...
    dart.setLibraryUri(Selector5, I[43]);
    return Selector5;
  });
  ...
  selector$.Selector6$ = dart.generic((A, B, C, D, E, F, S) => {
    ...
    dart.setLibraryUri(Selector6, I[43]);
    return Selector6;
  });
  ...
  value_listenable_provider.ValueListenableProvider$ = dart.generic(T => {
    ...
    dart.setLibraryUri(ValueListenableProvider, I[44]);
  ...
  dart.setLibraryUri(nested._NestedElement, I[11]);
  ...
  dart.setLibraryUri(nested._NestedHook, I[11]);
  ...
  dart.setLibraryUri(nested._NestedHookElement, I[11]);
  ...
  dart.setLibraryUri(nested.SingleChildWidget, I[11]);
  ...
  dart.setLibraryUri(nested.SingleChildStatefulElement, I[11]);
  ...
  dart.setLibraryUri(nested.SingleChildBuilder, I[11]);
  ...
  dart.setLibraryUri(nested.SingleChildStatelessWidgetMixin, I[11]);
  ...
  dart.setLibraryUri(nested.SingleChildStatefulWidgetMixin, I[11]);
  ...
  nested.SingleChildStateMixin$ = dart.generic(T => {
    ...
    dart.setLibraryUri(SingleChildStateMixin, I[11]);
  ...
  dart.setLibraryUri(nested._SingleChildStatefulMixinElement, I[11]);
  ...
  dart.setLibraryUri(nested.SingleChildInheritedElementMixin, I[11]);
  dart.trackLibraries("zapp_user_main", {
    "file:///zapp/project/.zapp_entry.dart": $46zapp_entry,
    "file:///zapp/project/lib/main.dart": main,
    "file:///zapp/project/.dart_tool/dartpad/web_plugin_registrant.dart": web_plugin_registrant,
    "file:///zapp/project/lib/configs/x_configs.dart": x_configs,
    "file:///zapp/project/lib/modules/grocery/x_groceries.dart": x_groceries,
    ...
    "file:///zapp/project/lib/modules/grocery/controllers/grocery_bloc.dart": grocery_bloc,
    "file:///zapp/project/lib/modules/grocery/models/grocery_mdl.dart": grocery_mdl,
    "file:///zapp/project/lib/modules/grocery/pages/grocery_pg.dart": grocery_pg,
    "file:///zapp/project/lib/modules/grocery/pages/parts/grocery_tile.dart": grocery_tile,
    "package:flutter_bloc/flutter_bloc.dart": flutter_bloc,
    "package:flutter_app/modules/grocery/controllers/grocery_bloc.dart": grocery_bloc$,
    "package:flutter_app/configs/x_configs.dart": x_configs$,
    "package:flutter_app/helpers/x_helpers.dart": x_helpers,
    "package:flutter_app/modules/grocery/x_groceries.dart": x_groceries$,
    ...
    "package:flutter_app/modules/grocery/models/grocery_mdl.dart": grocery_mdl$,
    "package:flutter_app/modules/grocery/pages/grocery_pg.dart": grocery_pg$,
    "package:flutter_app/modules/grocery/pages/parts/grocery_tile.dart": grocery_tile$,
    ...
    "file:///zapp/project/lib/modules/grocery/controllers/grocery_bloc.dart": ["grocery_event.dart", "grocery_state.dart"],
    "package:flutter_app/modules/grocery/controllers/grocery_bloc.dart": ["grocery_event.dart", "grocery_state.dart"],
  ...
  return {
    ...
    zapp__project__lib__modules__grocery__x_groceries: x_groceries,
    ...
    zapp__project__lib__modules__grocery__controllers__grocery_bloc: grocery_bloc,
    zapp__project__lib__modules__grocery__models__grocery_mdl: grocery_mdl,
    zapp__project__lib__modules__grocery__pages__grocery_pg: grocery_pg,
    zapp__project__lib__modules__grocery__pages__parts__grocery_tile: grocery_tile,
    flutter_bloc: flutter_bloc,
    modules__grocery__controllers__grocery_bloc: grocery_bloc$,
    configs__x_configs: x_configs$,
    helpers__x_helpers: x_helpers,
    modules__grocery__x_groceries: x_groceries$,
    bloc: bloc,
    provider: provider,
    ...
    modules__grocery__models__grocery_mdl: grocery_mdl$,
    modules__grocery__pages__grocery_pg: grocery_pg$,
    modules__grocery__pages__parts__grocery_tile: grocery_tile$,
    src__bloc: bloc$,
